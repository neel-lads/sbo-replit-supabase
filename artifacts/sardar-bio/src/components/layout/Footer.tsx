    ...
    <footer className="pt-16 pb-8 mt-24" style={{ background: "linear-gradient(135deg, #00C62C 0%, #004d11 100%)" }}>
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="md:col-span-2">
          ...
          <div className="w-10 h-1 rounded-full bg-white/30 mt-3 mb-4" />
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-white/70">
            <Link href="/" className="hover:text-white transition-colors w-fit text-sm">Home</Link>
            <Link href="/products" className="hover:text-white transition-colors w-fit text-sm">Products</Link>
            <Link href="/dealers" className="hover:text-white transition-colors w-fit text-sm">Find a Dealer</Link>
            <Link href="/contact" className="hover:text-white transition-colors w-fit text-sm">Contact Us</Link>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-14 pt-8 border-t border-white/20 text-sm text-white/50 flex flex-col md:flex-row justify-between items-center gap-4">
